       ...
       // static readonly Dictionary<string, string> skillExtnData = new Dictionary<string, string>();
        ...
        public void GetBcmsHistoricalData(string skillId)
        {
            ...
            try
            {
                ...
                var result = _bcmsReportClientObj.GetSkillHistoricalDataAsync(skillId).Result;
                if (result != null)
                {
                    ...
                    _reportObj.total_After_Call = result.TotalAfterCallTime.ToString();
                    _reportObj.total_Aux_Other = result.TotalAuxTime.ToString();
