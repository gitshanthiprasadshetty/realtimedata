...
namespace CMDataCollector.Connection
{
    public class CMConnection
    {
            ...
            try
            {
                ...
                {                    
                    ...
                    foreach (var skill in skillRange)
                    {
                        ...
                        t1.Start();
                       // Log.Debug("Child thread number : "+t1.ManagedThreadId);
                ...
                t.Start();
               // Log.Debug("Main thread number : " + t.ManagedThreadId);
                Thread.Sleep(100);
            }
            catch (Exception ex)
            {
        ...
        /// </summary>
        public void ExecuteCommand(CMConnection conn)
        {
        ...
        /// </summary>
        void ExecuteTrunkCommand(CMConnection connValue)
        {
            ...
            try
            {
                ...
                string skill1 = "1";
                // pass the command.
                //string c = connValue.SkillRange.Contains("system") ? "c mon bcms skill 1 \r\nt" : "c mon traffic trunk-groups \r\nt";
                // string c = "c mon traffic trunk-groups \r\nt";
                string c = "c mon bcms skill " + skill1 + "\r\nt";
                Log.Debug("ExecuteCommand command [" + c + "]:" + ConnectionKey);
                _commandReponse = connValue._conn.SendCommand(c);
