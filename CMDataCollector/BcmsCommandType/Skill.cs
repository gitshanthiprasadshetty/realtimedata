                    ...
                    foreach (var s1 in ts)
                    {
                        ...
                        if (b != null)
                        {
                            ...
                            _connValue.BcmsDashboard = new RealtimeData
                            {
                                ...
                                OldestInteractionWaitTime = (channel.ToLower() == "email") ? Convert.ToInt32(WorkQueueProxy.GetOldestWaitTime(extenstion)) : Convert.ToInt32(b.OldestCall) > 0 ? Convert.ToInt32(b.OldestCall) : 0,                                // SLPercentage = Convert.ToDecimal(b.SL),
